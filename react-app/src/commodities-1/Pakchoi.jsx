...
export default function Pakchoi	() {
  return (
  ...
  <div className="page-header d-print-none">
    <div className="container">
      <div className="row g-3 align-items-center">
        ...
        <div className="col">
          <h2 className="page-title">Pak Choi	
</h2>
          <div className="text-secondary">
            <ul className="list-inline list-inline-dots mb-0">
              <li className="list-inline-item">
              </li>
              <li className="list-inline-item">Pak Choi	
</li>
            </ul>
          </div>
        </div>
              ...
              <div id="chart-uptime" style={{ minHeight: 240 }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <g id="SvgjsG1360" className="apexcharts-yaxis-texts-g">
                        <text
                          id="SvgjsText1362"
                          fontFamily="inherit"
                          x={4}
                    ...
                    >
                      ...
                      <g id="SvgjsG1315" className="apexcharts-grid-borders">
                        <line
                          id="SvgjsLine1323"
                          x1={0}
                          y1={0}
