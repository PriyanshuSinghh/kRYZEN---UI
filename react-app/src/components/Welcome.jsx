      ...
      <form className="card card-md" action="./NavigationBar" method="get" autocomplete="off" novalidate="">
        <div className="card-body">
          ...
          <div className="mb-3">
            ...
            <input type="email" className="form-control" placeholder="Enter email" fdprocessedid="dxt97j"/>
          </div>
          <div className="mb-3">
            <label className="form-label">Password</label>
            <div className="input-group input-group-flat">
              <input type="password" className="form-control" placeholder="Password" autocomplete="off" fdprocessedid="p4uhd5"/>
          ...
          <div className="form-footer">
            <button type="submit" className="btn btn-primary w-100" fdprocessedid="yi5r1k">Sign in</button>
          </div>
        </div>
      </form>
